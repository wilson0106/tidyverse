...
Produza as tabelas a seguir utilizando as funções acima. Tente executar com apenas um comando e o mínimo de funções possíveis. \textbf{Utilize o operador pipe: \%\textgreater{}\%"}. \textbf{Se houver observações iguais remova-as}
